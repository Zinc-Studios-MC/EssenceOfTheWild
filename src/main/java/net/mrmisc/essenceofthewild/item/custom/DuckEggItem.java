...
/**
 * A duck egg that throws just like a vanilla chicken egg (see {@link net.minecraft.world.item.EggItem}),
 * launching a {@link ThrownDuckEgg} that can hatch a duckling.
 */
