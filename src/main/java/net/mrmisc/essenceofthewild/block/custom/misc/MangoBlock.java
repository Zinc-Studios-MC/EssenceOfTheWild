...
public class MangoBlock extends Block {
    ...
    public boolean canSurvive(BlockState pState, LevelReader pLevel, BlockPos pPos) {
        return pLevel.getBlockState(pPos.above()).is(EOTWBlocks.MANGO_LEAVES.get()) || pLevel.getBlockState(pPos.above()).is(EOTWBlocks.VANILLA_LEAVES.get()) && !pLevel.getBlockState(pPos.above()).isAir();
    }
}
