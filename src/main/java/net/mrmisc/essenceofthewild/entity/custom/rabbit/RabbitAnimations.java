package net.mrmisc.essenceofthewild.entity.custom.rabbit;// Save this class in your mod and generate all required imports
...
public class RabbitAnimations {
	...
	public static final AnimationDefinition walk = AnimationDefinition.Builder.withLength(0.6667F).looping()
		...
		.addAnimation("left_thigh", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.1667F, KeyframeAnimations.degreeVec(-13.75F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.3333F, KeyframeAnimations.degreeVec(-17.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("left_thigh", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(0.1667F, KeyframeAnimations.posVec(0.0F, 1.0F, -0.05F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.3333F, KeyframeAnimations.posVec(0.0F, 0.3F, -1.1F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.6667F, KeyframeAnimations.posVec(0.0F, -0.3F, 1.0F), AnimationChannel.Interpolations.CATMULLROM)
		))
		...
		.addAnimation("bone", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(0.1667F, KeyframeAnimations.posVec(0.0F, 1.3F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("left_ear_ice", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(391.4984F, -72.046F, -282.1886F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.1667F, KeyframeAnimations.degreeVec(383.9984F, -72.046F, -282.1886F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.3333F, KeyframeAnimations.degreeVec(391.4984F, -72.046F, -282.1886F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.5F, KeyframeAnimations.degreeVec(393.9984F, -72.046F, -282.1886F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.6667F, KeyframeAnimations.degreeVec(391.4984F, -72.046F, -282.1886F), AnimationChannel.Interpolations.CATMULLROM)
		))
		.addAnimation("right_ear_ice", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(391.4984F, 72.046F, 282.1886F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.1667F, KeyframeAnimations.degreeVec(383.9984F, 72.046F, 282.1886F), AnimationChannel.Interpolations.CATMULLROM),
