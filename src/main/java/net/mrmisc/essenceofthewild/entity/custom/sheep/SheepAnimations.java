package net.mrmisc.essenceofthewild.entity.custom.sheep;// Save this class in your mod and generate all required imports
...
public class SheepAnimations {
	public static final AnimationDefinition sheep_wool_eat = AnimationDefinition.Builder.withLength(2.5F)
