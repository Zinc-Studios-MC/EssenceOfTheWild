...
public class HareAnimations {
	...
	public static final AnimationDefinition walk = AnimationDefinition.Builder.withLength(0.9167F).looping()
		...
		.addAnimation("left_arm", new AnimationChannel(AnimationChannel.Targets.POSITION,
			...
			new Keyframe(0.2083F, KeyframeAnimations.posVec(0.0F, 2.74F, 2.74F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("right_arm", new AnimationChannel(AnimationChannel.Targets.POSITION,
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 2.0F, 1.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.125F, KeyframeAnimations.posVec(0.0F, 2.74F, 2.74F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.5F, KeyframeAnimations.posVec(0.0F, 1.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.6667F, KeyframeAnimations.posVec(0.0F, 2.0F, 1.0F), AnimationChannel.Interpolations.CATMULLROM)
		))
	...
	public static final AnimationDefinition run = AnimationDefinition.Builder.withLength(0.3333F).looping()
		...
		.addAnimation("left_arm", new AnimationChannel(AnimationChannel.Targets.POSITION,
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 3.0F, -0.7F), AnimationChannel.Interpolations.CATMULLROM),
			...
			new Keyframe(0.25F, KeyframeAnimations.posVec(0.0F, 2.38F, 0.03F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("left_thigh", new AnimationChannel(AnimationChannel.Targets.POSITION,
			...
			new Keyframe(0.25F, KeyframeAnimations.posVec(0.0F, -1.1F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
